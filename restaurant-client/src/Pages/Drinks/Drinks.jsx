            ...
            >
                ...
                <SwiperSlide>
                    <div
                        ...
                        style={{
                            backgroundImage:
                                "url(https://images.pexels.com/photos/158053/fresh-orange-juice-squeezed-refreshing-citrus-158053.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)",
                        }}
                    >
                        <div className="bg-black bg-opacity-60 p-6 rounded-lg">
                ...
                <SwiperSlide>
                    <SwiperSlide>
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    "url(https://images.pexels.com/photos/4109238/pexels-photo-4109238.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)",
                            }}
                        >
                            <div className="bg-black bg-opacity-60 p-6 rounded-lg">
